define windows_group_policy::local::user_client_side_extensions(
  $ensure    = 'present',
...
)
{
  ...
  if ($software_installation) { $software_installation_guid = '{BACF5C8A-A3C7-11D1-A760-00C04FB9603F}' } else { $software_installation_guid = ''}
