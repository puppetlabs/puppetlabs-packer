...
class packer::vmtools(
  ...
  if ( ($facts['osfamily'] == 'debian' and $facts['operatingsystemmajrelease'] in ['7', '8', '9', '10', 'bullseye/sid', '16.04', '14.04', '18.04', '18.10', '20.04']) or
        ($facts['osfamily'] == 'redhat' and $facts['operatingsystemmajrelease'] in ['7', '8', '25', '26', '27', '28', '29', '30', '31', '32']) or
